...
const sources = [
  "Kumar, C., Faircloth, A., Leggate, W., and Redman, A. (2022). Impact of continuous drying method on drying quality of southern pine sawn timber. BioResources 17(1), 574–591.",
  "Leggate, W., Kumar, C., McGavin, R.L., Faircloth, A., and Knackstedt, M. (2021). The effects of drying method on the wood permeability, wettability, treatability, and gluability of southern pine from Australia. BioResources 16(1), 698–720.",
  "Rahimi, S., Nasir, V., Avramidis, S., and Sassani, F. (2023). The role of drying schedule and conditioning in moisture uniformity in wood: A machine learning approach. Polymers 15, article 792.",
  "Andersson, S. (2008). Drying of timber in progressive kilns. Wood Material Science and Engineering 3(1–2).",
  "Cown, D.J. (1999). NZ Radiata Pine and Douglas-fir: Suitability for Processing. Forest Research Bulletin No. 216. New Zealand Forest Research Institute.",
  "International Plant Protection Convention (IPPC). ISPM 15: Regulation of wood packaging material in international trade.",
  "NZS 3604:2011. Timber-framed buildings. Standards New Zealand.",
  "NZS 3631:1988. New Zealand Timber Grading Rules. Standards New Zealand.",
  "AS/NZS 4787:2001. Timber — Assessment of Drying Quality. Standards Australia / Standards New Zealand.",
  "Red Stag Timber. Measuring Moisture in Timber. redstagtimber.co.nz",
] as const;
  ...
  return <article className="ria kda">
    <header className="ria-hero kda-hero">
      <div className="ria-hero-copy">
        ...
        <div className="ria-meta"><span>BY FPX</span><span>2026</span><span>10 MIN READ</span></div>
      </div>
      <div className="ria-hero-image">
        <img src="/images/kiln-drying-cover.png" alt="Stacked Radiata Pine timber inside a kiln drying facility in New Zealand"/>
    ...
    <div className="ria-reading kda-reading">
      ...
      <section id="conventional-batch-kilns" className="ria-section kda-section">
        ...
        <figure className="kda-photo-card"><div><img src="/images/conventional-batch-kiln-radiata-pine-timber.png" alt="Conventional batch kiln loaded with stacked Radiata Pine timber"/></div><figcaption><span>CONVENTIONAL BATCH</span><strong>Flexible schedules for varied production.</strong><p>Conventional batch kilns allow flexible scheduling across mixed section sizes, the industry standard across NZ mills.</p></figcaption></figure>
      </section>
      ...
      <section id="continuous-kilns" className="ria-section kda-section">
        ...
        <figure className="kda-photo-card kda-photo-right"><div><img src="/images/continuous-kiln-radiata-pine-timber-drying.png" alt="Continuous kiln tunnel drying Radiata Pine timber on an automated line"/></div><figcaption><span>CONTINUOUS KILN</span><strong>Fixed drying conditions at industrial scale.</strong><p>Continuous kilns move timber through a fixed drying environment, delivering tighter moisture distribution at scale.</p></figcaption></figure>
      ...
      <section id="research-study" className="ria-section kda-section">
        ...
        <div className="ria-copy"><p>A 2022 peer-reviewed study by Kumar et al. (BioResources) compared a continuous kiln against ultra-high temperature (HTD) batch drying for Queensland plantation-grown southern pine, a plantation softwood closely related to Radiata Pine, using AS/NZS standard test methods.</p></div>
      ...
      <section id="on-delivery" className="ria-section kda-section">
        ...
        <figure className="kda-photo-card"><div><img src="/images/radiata-pine-timber-delivery-moisture-testing.png" alt="Radiata Pine timber packs being inspected for moisture content before delivery"/></div><figcaption><span>BEFORE DISPATCH</span><strong>Check the specification at the mill.</strong><p>Kiln-dried timber purchased through FPX is checked at the mill to confirm it meets the required specification before dispatch.</p></figcaption></figure>
      </section>
    </div>

    <section id="digital-market" className="ria-sourcing kda-sourcing"><div><span>07 · FPX PLATFORM</span><h2>Radiata Pine Sourcing<br/><em>in a Digital Market</em></h2></div><div className="ria-sourcing-copy"><p>Purchasing decisions should be guided by whether timber meets the relevant grade and moisture specification for its intended use. At FPX, we provide the digital infrastructure for the New Zealand timber supply chain. Through FPX Sourcing, we act as a dedicated partner for timber businesses, providing faster and more reliable access to supply.</p><p>FPX complements existing phone calls, supplier relationships, and day-to-day workflows by providing real-time visibility of timber supply. Buyers can quickly find exact specifications while still working directly with trusted partners. This shared, data-driven view makes it easier to align project requirements with available stock, improving speed, accuracy, and decision-making across the supply chain.</p><p>Rather than working through fragmented information, buyers can make sourcing decisions based on structured, up-to-date availability data that supports operational confidence and accuracy.</p><h3>What would your workflow look like if timber availability was visible in real time?</h3><p>Sign up free or book a walkthrough with our team.</p><div className="kda-actions"><a href="https://app.fpx.nz/sourcing-sign-up">Sign up free <Arrow/></a><Link href="/contact-us">Talk to Us <Arrow/></Link></div></div></section>
    ...
    <section className="ria-sources"><Eyebrow>SOURCES</Eyebrow><h2>Research and industry references.</h2><p>This article draws on publicly available research and industry resources for accuracy. Key references include:</p><ol>{sources.map(source=><li key={source}>{source}</li>)}</ol></section>
    <section className="ria-next"><div><Eyebrow>NEXT IN INDUSTRY INSIGHTS</Eyebrow><h2>More timber knowledge from FPX.</h2><p>Explore practical guides covering timber characteristics, processing, specifications and sourcing.</p></div><Link href="/industry-insights">View Industry Insights <Arrow/></Link></section>
  </article>;
}
