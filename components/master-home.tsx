...
const AppButtons=()=> <div className="m-actions"><a className="m-btn m-btn-primary" href="https://app.fpx.nz/guest-fpx-sourcing-copy">Browse timber <Arrow/></a><a className="m-btn m-btn-ghost" href="https://app.fpx.nz/guest-fpx-sourcing-copy?request=1">Create a request <Arrow/></a></div>;
...
function PlatformStory(){
  const routes=[
    ["Browse Stock","Search available timber by category, grade and specification.","https://app.fpx.nz/guest-fpx-sourcing-copy","AVAILABLE TIMBER"],
    ["View Offers","Review current packet and bulk timber opportunities.","https://app.fpx.nz/guest-fpx-sourcing-copy?view=offers","CURRENT OPPORTUNITIES"],
    ["Create a Request","Tell FPX what you need and receive suitable sourcing options.","https://app.fpx.nz/guest-fpx-sourcing-copy?request=1","EXACT REQUIREMENTS"]
  ] as const;
