...
export function SourceTimberPage(){return <>
  ...
  <section className="pst-routes pst-routes-no-app">
    <article id="source-request" className="pst-route">
      ...
      <a className="pst-route-cta" href="https://app.fpx.nz/guest-fpx-sourcing-copy?request=1">Go to Request List <Arrow/></a>
    </article>
    ...
    <article id="source-stock" className="pst-route is-reverse">
      ...
      <a className="pst-route-cta" href="https://app.fpx.nz/guest-fpx-sourcing-copy">Browse stock <Arrow/></a>
    </article>
    ...
    <article id="source-offers" className="pst-route">
      ...
      <a className="pst-route-cta" href="https://app.fpx.nz/guest-fpx-sourcing-copy?view=offers">View offers & enquire <Arrow/></a>
    </article>
  </section>
