...
export function CustomersPage(){
  ...
  return <>
      ...
      <div className="poc4-experience">
        ...
        <div className="poc4-details">
          ...
          <div className="poc4-actions">
            <a href="https://app.fpx.nz/guest-fpx-sourcing-copy">Browse timber <Arrow/></a>
            <a href="https://app.fpx.nz/guest-fpx-sourcing-copy?request=1">Create a request <Arrow/></a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="poc2-close">
      ...
      <div className="m-actions"><a className="m-btn m-btn-primary" href="https://app.fpx.nz/guest-fpx-sourcing-copy">Browse timber <Arrow/></a><a className="m-btn m-btn-ghost" href="https://app.fpx.nz/guest-fpx-sourcing-copy?request=1">Create a request <Arrow/></a></div>
    </section>
  </>;
}
  ...
  return <>
    ...
    <section className="pab3-close">
      ...
      <div className="m-actions">
        <a className="m-btn m-btn-primary" href="https://app.fpx.nz/guest-fpx-sourcing-copy">Browse timber <Arrow/></a>
        <a className="m-btn m-btn-ghost" href="https://app.fpx.nz/guest-fpx-sourcing-copy?request=1">Create a request <Arrow/></a>
      </div>
    </section>
  </>;
}
...
export function ContactPage(){
  ...
  <section className="pct2-start">
    ...
    <nav className="pct2-routes" aria-label="Ways to start sourcing timber through FPX">
      <a href="https://app.fpx.nz/guest-fpx-sourcing-copy">
        <span>01</span>
      ...
      <a href="https://app.fpx.nz/guest-fpx-sourcing-copy?request=1">
        <span>02</span>
      ...
      <a href="https://app.fpx.nz/guest-fpx-sourcing-copy?view=offers">
        <span>03</span>
