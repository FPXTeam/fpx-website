...
export const pageData: Record<string,{eyebrow:string;title:string;intro:string}> = {
  ...
  "how-fpx-works": {eyebrow:"HOW FPX WORKS",title:"Three ways to start. One supported process.",intro:"Browse available timber, review current offers or create a detailed request. FPX keeps the next steps connected."},
...
export const AppButtons=()=> <div className="m-actions"><a className="m-btn m-btn-primary" href="https://app.fpx.nz/guest-fpx-sourcing-copy">Browse timber <Arrow/></a><a className="m-btn m-btn-ghost" href="https://app.fpx.nz/guest-fpx-sourcing-copy?request=1">Create a request <Arrow/></a></div>;
