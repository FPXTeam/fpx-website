...
const pages = [
  ...
  { path:"/fpx-sourcing", modified:"2026-09-21", changeFrequency:"weekly" as const, priority:.9 },
  { path:"/timber", modified:"2026-09-18", changeFrequency:"weekly" as const, priority:.9 },
  { path:"/manufacturing", modified:"2026-09-21", changeFrequency:"weekly" as const, priority:.8 },
  { path:"/building-construction", modified:"2026-09-21", changeFrequency:"weekly" as const, priority:.8 },
  { path:"/outdoor-landscaping", modified:"2026-09-21", changeFrequency:"weekly" as const, priority:.8 },
  { path:"/dunnage", modified:"2026-09-21", changeFrequency:"weekly" as const, priority:.8 },
  { path:"/how-fpx-works", modified:"2026-09-21", changeFrequency:"monthly" as const, priority:.8 },
  ...
  { path:"/timber-growth-rings", modified:"2026-09-21", changeFrequency:"yearly" as const, priority:.7 },
  { path:"/the-science-of-kiln-drying", modified:"2026-09-21", changeFrequency:"yearly" as const, priority:.8 },
